...
- **Schrift:** Ursprünglich war Special Elite durchgehend im Einsatz. Für den seriöseren Auftritt tragen jetzt **Fraunces** (Überschriften) und **Inter** (Fliesstext, Buttons) die Seite; Special Elite bleibt für die kleinen gesperrten Labels über den Abschnitten — dort liest sie sich wie ein aufgedruckter Stempel statt wie eine abgetippte Website. Sagt Bescheid, falls ihr die alte Variante zurückwollt.
- **Seitendesign:** Runde Pillen-Buttons, gekippte Polaroids, gestrichelte Linien, Emoji-Trenner und die flächigen Pastelltöne sind raus. Stattdessen: rechteckige Buttons mit gesperrter Versalschrift, Haarlinien statt Rahmen, ein Magazin-Raster auf der Startseite und ein dunkler Footer. Rosé und Lila bleiben als Markenfarben, aber dunkler — als Akzent statt als Fläche, und damit erstmals auch als Text lesbar.
